...
parser.add_argument('--dataset', help='The path of the dataset.', type=str, default='Football_Seg')
...
parser.add_argument('--num_classes', help='The number of classes to be segmented.', type=int, default=6)
parser.add_argument('--random_crop', help='Whether to randomly crop the image.', type=str2bool, default=False)
parser.add_argument('--crop_height', help='The height to crop the image.', type=int, default=288)#864,288,144,432,576,720
parser.add_argument('--crop_width', help='The width to crop the image.', type=int, default=288)#864,288,144,432,576,720
parser.add_argument('--batch_size', help='The training batch size.', type=int, default=8)
parser.add_argument('--valid_batch_size', help='The validation batch size.', type=int, default=1)
parser.add_argument('--num_epochs', help='The number of epochs to train for.', type=int, default=5)
...
parser.add_argument('--checkpoint_freq', help='How often to save a checkpoint.', type=int, default=25)
parser.add_argument('--validation_freq', help='How often to perform validation.', type=int, default=1)
parser.add_argument('--num_valid_images', help='The number of images used for validation.', type=int, default=18)
parser.add_argument('--data_shuffle', help='Whether to shuffle the data.', type=str2bool, default=True)
parser.add_argument('--random_seed', help='The random shuffle seed.', type=int, default=32)
...
parser.add_argument('--learning_rate', help='The initial learning rate.', type=float, default=0.0001)
...
#train_image_names, train_label_names = get_dataset_info(args.dataset)
...
model_checkpoint = tf.keras.callbacks.ModelCheckpoint(
    filepath=os.path.join(
        ...
        'miou_{val_mean_io_u:04f}_ep_{epoch:02d}.keras'  # Change the extension to .keras
    ),
