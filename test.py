...
parser.add_argument('--base_model', help='Choose the backbone model.', type=str, default='ResNet50')
...
parser.add_argument('--crop_height', help='The height to crop the image.', type=int, default=224)
parser.add_argument('--crop_width', help='The width to crop the image.', type=int, default=224)
